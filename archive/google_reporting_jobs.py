...
CLIENT_SECRETS_FILE = "./ignore/SOHclient_secret.json"
...
def list_report_types(youtube_reporting, **kwargs):
    ...
    print(dir(youtube_reporting))
    print(youtube_reporting)
    print(dir(youtube_reporting.reportTypes()))
...
if __name__ == '__main__':
    ...
    youtube_reporting = build('youtubereporting', 'v1', developerKey=API_KEY)
